...
export default function FooterSection() {
  return (
    <footer id="contact" className="apx-font-body bg-zinc-50">
      <div className="mx-auto grid max-w-screen-2xl grid-cols-1 gap-12 px-8 py-16 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-5">
          ...
          <ul className="space-y-3">
            {["WHO-GMP Certified", "ISO 9001:2015", "GLP Compliance", "FDCA Approved", "MSME Registered"].map((cert) => (
              <li key={cert} className="text-sm text-zinc-600">{cert}</li>
            ))}
          </ul>
        </div>
